...
> Checkpoint historique sur `ce083dec`. L’intégration ultérieure sur `3abf6a6` valide le repli OCR, la suite macOS et des previews isolées : voir [le rapport actuel](2026-09-08-integration-3.6.0.md). Les résultats ci-dessous restent ceux de leur exécution initiale.
