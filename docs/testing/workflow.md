...
**État : préparé, 0/10 tâches observées dans ce pilote.** Les régressions synthétiques de ce correctif ne comptent pas comme dix tâches. Utiliser [le registre](pilot-10-tasks.csv) pour les dix prochaines tâches éligibles, sans choisir seulement les succès.
