...
/// The service names, signing identifier and team are declared by the
/// contract package; this SQLCipher-free client product only adds the
/// convenience constructor so consumers cannot drift onto a similarly named
/// or differently signed XPC endpoint.
extension ResearchVaultServiceContract {
